...
export function MyRoutes() {
  ...
  queryFn: async () => {
    const result = await mostrarEmpresa({ idusuario: datausuarios?.idauth });
    return result ?? null; // ← nunca retorna undefined
  },
  enabled: !!datausuarios?.idauth, // ← el ?. evita el crash
  });
