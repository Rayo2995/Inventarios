      ...
      <Container>
        <div className="content-wrapper-context">
          <span className="titulo">
            {<v.iconoempresa />}
            Bienvenido  a&nbsp;
            <EmpresaName>{dataempresa?.empresa || "SS-POCKET"}</EmpresaName>
          </span>
          <div className="content-text">
            SS-POCKET te ayuda a tener un control de tus inventarios desde
...
const Container = styled.div`
  ...
  .cuadros {
    transition: transform 0.6s cubic-bezier(0.4, 0, 0.2, 1);  /* solo transform, no todo */
    position: absolute;
    height: 100%;
    width: 100%;
    bottom: 0;
  ...
  &:hover {
    ...
    .cuadros {
      transform: rotate(37deg) skew(2deg) scale(1.2);  /* ← reducido, sin rotateX/Y redundantes */
    }
  }
...
const EmpresaName = styled.span`
  ...
  padding: 2px 6px;
  border-radius: 6px;
  margin-left: 1px; /* separación mínima */
